import { saveReading, getReadings, getReadingsByDateRange, saveEnergyReading, getEnergyReadings, getEnergyReadingsByDateRange } from '../database/db.js';
...
export const getLatestEnergyReading = async (_req, res) => {
    try {
